  ...
  return (
    <Sidebar>
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          <SidebarGroupLabel>Słownik</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
        ...
        <SidebarGroup>
          <SidebarGroupLabel>Boxy</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
        ...
        <SidebarGroup>
          <SidebarGroupLabel>Administratorzy</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
        ...
        <SidebarGroup>
          <SidebarGroupLabel>Użytkownicy</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
