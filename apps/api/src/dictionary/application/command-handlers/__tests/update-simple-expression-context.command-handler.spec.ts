...
import { UpdateSimpleExpressionContextCommandHandler } from '../update-simple-expression-context.command-handler';
...
describe('UpdateSimpleExpressionContextCommandHandler', () => {
  ...
  let handler: UpdateSimpleExpressionContextCommandHandler;
  ...
  beforeEach(() => {
    ...
    handler = new UpdateSimpleExpressionContextCommandHandler(
  ...
  it('should update a simple expression context', async () => {
    ...
    const expressionContext = new ExpressionContext(
      ...
      'old translation',
      false,
      ExpressionType.fromString(SIMPLE_EXPRESSION),
      null,
      false,
      null,
      null,
