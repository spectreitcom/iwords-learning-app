...
import { UpdateVerbExpressionContextCommandHandler } from '../update-verb-expression-context.command-handler';
...
describe('UpdateVerbExpressionContextCommandHandler', () => {
  ...
  let handler: UpdateVerbExpressionContextCommandHandler;
  ...
  beforeEach(() => {
    ...
    handler = new UpdateVerbExpressionContextCommandHandler(
  ...
  it('should update a verb expression context', async () => {
