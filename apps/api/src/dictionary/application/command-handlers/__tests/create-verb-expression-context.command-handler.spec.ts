...
import { CreateVerbExpressionContextCommandHandler } from '../create-verb-expression-context.command-handler';
...
describe('CreateVerbExpressionContextCommandHandler', () => {
  ...
  let handler: CreateVerbExpressionContextCommandHandler;
  ...
  beforeEach(() => {
    ...
    handler = new CreateVerbExpressionContextCommandHandler(
  ...
  it('should create a verb expression context', async () => {
