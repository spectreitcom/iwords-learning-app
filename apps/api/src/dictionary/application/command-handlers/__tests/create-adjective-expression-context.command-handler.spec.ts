...
import { CreateAdjectiveExpressionContextCommandHandler } from '../create-adjective-expression-context.command-handler';
...
describe('CreateAdjectiveExpressionContextCommandHandler', () => {
  ...
  let handler: CreateAdjectiveExpressionContextCommandHandler;
  ...
  beforeEach(() => {
    ...
    handler = new CreateAdjectiveExpressionContextCommandHandler(
  ...
  it('should create an adjective expression context', async () => {
    ...
    expect(eventPublisher.lastMerged.getType().value).toBe('adjective');
