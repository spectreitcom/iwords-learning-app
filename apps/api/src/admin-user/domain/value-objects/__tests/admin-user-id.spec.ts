...
describe('AdminUserId', () => {
  describe('create', () => {
    it('should create AdminUserId with random UUID', () => {
      ...
      expect(adminUserId.value).toMatch(
  ...
  describe('fromString', () => {
    ...
    it('should throw error for invalid UUID format - missing dashes', () => {
      ...
      expect(() => AdminUserId.fromString(invalidUuid)).toThrow(
        'AdminUserId is not valid',
      );
    });
  ...
  describe('equals', () => {
    ...
    it('should return false for different UUID values', () => {
      const adminUserId1 = AdminUserId.fromString(
        '123e4567-e89b-12d3-a456-426614174000',
      );
      const adminUserId2 = AdminUserId.fromString(
        '987f6543-c21a-43e2-b789-537725285111',
      );
    ...
    it('should return true when comparing same instance', () => {
      const adminUserId = AdminUserId.fromString(
        '123e4567-e89b-12d3-a456-426614174000',
      );
